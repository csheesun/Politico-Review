<?php
	...
	$result = mysqli_query($con, "SELECT * FROM VOTE, POLITICO, USER WHERE USER.userGender = '남자' AND USER.userID = VOTE.userID AND VOTE.politicoID = POLITICO.politicoID GROUP BY VOTE.politicoID ORDER BY COUNT(VOTE.politicoID) DESC;");
