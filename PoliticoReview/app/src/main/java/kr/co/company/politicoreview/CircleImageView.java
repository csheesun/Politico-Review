...
public class CircleImageView extends AppCompatImageView {  //원래 ImageView에서 이걸로 고침, AutoResizeTextView 와 동일
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageView, defStyle, 0); //여기 해결 위해 또 하나 필요
